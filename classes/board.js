/**
 This class represents the board, contains methods that checks the state of the board, inserts a symbol, etc..
...
export default class Board {
  ...
  printFormattedBoard() {
    ...
    console.log('%c' + formattedString, 'color: #c11dd4;font-size:16p');
  }
  ...
  // Checks if the board has no spaces available
  ...
  */
  ...
  // Returns an array containing the available moves for the current state
